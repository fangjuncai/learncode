...
public final class IpConvertUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(bigIntToString(new BigInteger(
                "338288524927261089663928186234336861057")));
        System.out.println(bigIntToString(new BigInteger(
                "170148118")));

        System.out.println(stringToBigInt("221.181.118.0"));

        System.out.println(bigIntToString(new BigInteger(
                "3719657215")));

        System.out.println(stringToBigInt("fe80::5b81"));
        String s = new String("fe80::8984:de33:85aa:5b81");
        String [] ss =s.split(":");
