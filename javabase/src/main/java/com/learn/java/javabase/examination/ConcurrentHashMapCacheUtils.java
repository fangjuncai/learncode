...
public class ConcurrentHashMapCacheUtils {
    ...
    public static void setCache(String cacheKey, Object cacheValue, long cacheTime) {
        ...
        System.out.println("have set key :" + cacheKey);
    }

    public static void setCacheNum(int num) {
    ...
    public static void clear() {
        System.out.println("have clean all key !");
    ...
    public static void deleteCache(String cacheKey) {
        ...
        if (cacheValue != null) {
            System.out.println("have delete key :" + cacheKey);
            CURRENT_SIZE = CURRENT_SIZE - 1;
        }
    }
    ...
    private static void deleteLRU() {
        System.out.println("delete Least recently used run!");
    ...
    static void deleteTimeOut() {
        System.out.println("delete time out run!");
        ...
        System.out.println("delete cache count is :" + deleteKeyList.size());
    }
